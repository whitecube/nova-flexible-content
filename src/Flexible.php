...
class Flexible extends Field
{
    ...
    /**
     * Show buttons to add layout at position between existing layouts
     *
     * @param boolean $value
     * @return $this
     */
    public function withMultipleButtons(bool $value = true)
    {
        $this->withMeta(['withMultipleButtons' => $value]);
        return $this;
    }
