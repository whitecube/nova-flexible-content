<template>
    <div class="relative bg-white pl-8 mb-4" :id="group.key">
        ...
        <div class="absolute z-10 bg-white border-t border-l border-b border-60 rounded-l pin-l pin-t w-8">
            ...
            <button class="group-control btn border-t border-r border-40 w-8 h-8 block" title="Move down"
                    @click.prevent="moveDown">
                <icon type="arrow-down" view-box="0 0 8 4.8" width="10" height="10"/>
            </button>
            <button v-if="canRemove" class="group-control btn border-t border-r border-40 w-8 h-8 block" title="Delete"
...
<script>
    ...
    export default {
        ...
        props: ['validationErrors', 'group', 'canRemove'],
