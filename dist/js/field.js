...
Nova.booting(function (Vue, router, store) {
    ...
    Vue.component('icon-arrow-down', __webpack_require__(25));
    Vue.component('icon-arrow-up', __webpack_require__(27));
    Vue.component('icon-plus-square', __webpack_require__(29));
    Vue.component('icon-minus-square', __webpack_require__(31));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    fill: function fill(formData) {
      ...
      formData.fd.append(this.field.attribute, this.value.length ? JSON.stringify(this.value) : "");

      // Append file uploads
      for (var file in this.files) {
        formData.fd.append(file, this.files[file]);
      }
    },
    ...
    appendFieldAttribute: function appendFieldAttribute(formData, attribute) {
      ...
      if (formData.fd.has("___nova_flexible_content_fields")) {
        registered = JSON.parse(formData.get("___nova_flexible_content_fields"));
      }

      registered.push(attribute);

      formData.fd.set("___nova_flexible_content_fields", JSON.stringify(registered));
    },
                ...
                _vm.removeMessage
                  ? _c("div", { staticClass: "confirm-message" }, [
                      _vm.field.confirmRemoveMessage
                        ? _c("span", [
                            _vm._v(_vm._s(_vm.field.confirmRemoveMessage))
                          ])
                        : _vm._e(),
                      _vm._v(" "),
                      _c(
                        ...
                        {
                          staticClass:
                            "text-danger btn mx-1 focus:outline-none",
                          attrs: { type: "button" },
                          on: {
                            click: function($event) {
                              $event.preventDefault()
